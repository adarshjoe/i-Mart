      ...
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return ProductDetail(
            productId: widget.productData['productId'], // Pass productId
          );
        }));
      },
      child: Padding(
          ...
          child: Stack(
            ...
            children: [
              ...
              if (widget.productData != null &&
                  widget.productData.containsKey('rating'))
              ...
              Positioned(
                ...
                child: IconButton(
                  ...
                  icon: _favoriteProvider.getFavoriteItem.containsKey(widget.productData['productId'])
                      ? Icon(
                          Icons.favorite,
                          color: Colors.white,
                          size: 16,
